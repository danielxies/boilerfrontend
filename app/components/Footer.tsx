  ...
  return (
    <footer className="w-full bg-[#1a1a1a] border-t border-[#2a2a2a] py-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-3 items-center">
        ...
        <p className={`${vastago.className} text-[#d1cfbf] text-center`}>
          Made with <span className="text-rose-400">♥</span> by Daniel
        </p>
        ...
        <a 
          ...
          className="text-[#d1cfbf] hover:text-white transition-colors flex items-center space-x-2 justify-end"
        >
